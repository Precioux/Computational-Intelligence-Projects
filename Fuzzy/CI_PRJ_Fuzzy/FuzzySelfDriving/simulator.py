...
def run():
    ...
    while True:
        ...
        # time.sleep(5)
        left_dist = math.sqrt(
            (car.car_center[0] - car.edge_points[0][0]) ** 2 + (car.car_center[1] - car.edge_points[0][1]) ** 2)
        center_dist = math.sqrt(
            (car.car_center[0] - car.edge_points[1][0]) ** 2 + (car.car_center[1] - car.edge_points[1][1]) ** 2)
        right_dist = math.sqrt(
            (car.car_center[0] - car.edge_points[2][0]) ** 2 + (car.car_center[1] - car.edge_points[2][1]) ** 2)
